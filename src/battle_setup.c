...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_CINDY] = REMATCH(TRAINER_CINDY, TRAINER_CINDY_3, TRAINER_CINDY_4, TRAINER_CINDY_5, TRAINER_CINDY_6, MAP_ROUTE104),
    ...
    [REMATCH_TH3E] = REMATCH(TRAINER_TH3E_1, TRAINER_TH3E_2, TRAINER_TH3E_3, TRAINER_TH3E_4, TRAINER_TH3E_5, MAP_RUSTBORO_CITY),
